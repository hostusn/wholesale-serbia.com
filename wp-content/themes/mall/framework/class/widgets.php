				...
				echo '<div class="cmsmasters_slider_project">' . 
					'<div class="cmsmasters_slider_project_outer">';
						...
						echo '<div class="cmsmasters_slider_project_inner">';
							...
							cmsmasters_slider_post_heading(get_the_ID(), 'project', 'h4', $cmsmasters_project_link_redirect, $cmsmasters_project_link_url, true, $cmsmasters_project_link_target);
			...
			if ($tweets != '') {
				...
				echo '<div class="cmsmasters_notice cmsmasters_notice_error cmsmasters_theme_icon_cancel">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . esc_html__('Please add your Twitter API keys', 'mall') . ', ' . '<a target="_blank" href="http://cmsmasters.net/twitter-functionality/">' . esc_html__('read more how', 'mall') . '</a></p>' . "\n" . 
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
...
function mall_theme_add_custom_widgets($widgets) {
...
add_filter('cmsmasters_custom_widgets_filter', 'mall_theme_add_custom_widgets');
